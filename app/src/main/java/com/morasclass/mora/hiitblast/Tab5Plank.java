...
public class Tab5Plank extends Fragment implements  View.OnClickListener, VideoView.OnTouchListener, SeekBar.OnSeekBarChangeListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab5plank, container, false);
        ...
        //video
            VideoView vid = (VideoView) rootView.findViewById(R.id.videoPlank);
            String path = "android.resource://" + this.getActivity().getPackageName() + "/" + R.raw.plankton;
            vid.setOnTouchListener(this);
            SeekBar bar = (SeekBar) rootView.findViewById(R.id.plankSeek);
