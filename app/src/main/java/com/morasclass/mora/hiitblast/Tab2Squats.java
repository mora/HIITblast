...
public class Tab2Squats extends Fragment implements  View.OnClickListener, VideoView.OnTouchListener, SeekBar.OnSeekBarChangeListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab2squats, container, false);
        ...
        //video
        VideoView vid = (VideoView) rootView.findViewById(R.id.videoSquat);
        String path = "android.resource://" + this.getActivity().getPackageName() + "/" + R.raw.squat;
