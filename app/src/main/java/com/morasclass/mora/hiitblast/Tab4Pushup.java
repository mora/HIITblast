...
public class Tab4Pushup extends Fragment implements  View.OnClickListener, VideoView.OnTouchListener, SeekBar.OnSeekBarChangeListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab4pushup, container, false);
        ...
        //video
            VideoView vid = (VideoView) rootView.findViewById(R.id.videoPushup);
            String path = "android.resource://" + this.getActivity().getPackageName() + "/" + R.raw.pushup;
            vid.setOnTouchListener(this);
            SeekBar bar = (SeekBar) rootView.findViewById(R.id.pushSeek);
